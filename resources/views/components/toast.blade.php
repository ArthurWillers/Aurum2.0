    ...
    <div class="fixed top-0 inset-x-0 flex items-start justify-center lg:justify-end p-4 z-50 pointer-events-none">
        ...
        <div x-data="{ show: false, progress: 100 }" x-init="$nextTick(() => {
            ...
            <div class="flex items-center gap-4 p-4">
                ...
                @if ($type === 'success')
                    <div
                        class="flex items-center justify-center w-8 h-8 bg-green-100 dark:bg-green-900/20 rounded-full flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5 text-green-600 dark:text-green-400">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                        </svg>
                    </div>
                @elseif ($type === 'error')
                    <div
                        class="flex items-center justify-center w-8 h-8 bg-red-100 dark:bg-red-900/20 rounded-full flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5 text-red-600 dark:text-red-400">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                        </svg>
                    </div>
                @elseif ($type === 'warning')
                    <div
                        class="flex items-center justify-center w-8 h-8 bg-yellow-100 dark:bg-yellow-900/20 rounded-full flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5 text-yellow-600 dark:text-yellow-400">
                ...
                @else
                    <div
                        class="flex items-center justify-center w-8 h-8 bg-blue-100 dark:bg-blue-900/20 rounded-full flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
