    ...
    <div
        ...
        <form action="{{ route('transactions.update', $transaction) }}" method="POST" class="space-y-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2 sm:gap-6 items-center justify-center my-6">
                <div class="flex items-center gap-2 bg-neutral-100 dark:bg-neutral-700 rounded-lg px-4 py-2 shadow-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <span class="text-xs sm:text-sm text-neutral-700 dark:text-neutral-200 font-semibold">Criado
                        em:</span>
                    <span
                        class="text-xs sm:text-sm font-mono text-neutral-600 dark:text-neutral-300">{{ $transaction->created_at->format('d/m/Y H:i:s') }}</span>
                </div>
                <div class="flex items-center gap-2 bg-neutral-100 dark:bg-neutral-700 rounded-lg px-4 py-2 shadow-sm">
                    ...
                    <span class="text-xs sm:text-sm text-neutral-700 dark:text-neutral-200 font-semibold">Atualizado
                        em:</span>
                    <span
                        class="text-xs sm:text-sm font-mono text-neutral-600 dark:text-neutral-300">{{ $transaction->updated_at->format('d/m/Y H:i:s') }}</span>
                </div>
            </div>
